...
export class MMDLoader extends THREE.Loader {
    ...
    // loadFile(url: string, responseType: string, mimeType: string, onProgress?: (e: ProgressEvent) => any) {
    ...
    //         const request = loader.load( url, resolve, onProgress, (e) => reject(e.error) )
    //     })
    // }
 ...
 */
export class VectorKeyframeTrackEx extends THREE.VectorKeyframeTrack{
...
export class QuaternionKeyframeTrackEx extends THREE.QuaternionKeyframeTrack {
    TimeBufferType: typeof Float64Array = Float64Array
    ...
    InterpolantFactoryMethodCubicBezier = function( result ) {
        return new CubicBezierInterpolation( this.times, this.values, this.getValueSize(), result, this.interpolationParameters );
    }
...
THREE.MMDLoader.QuaternionKeyframeTrackEx.prototype.;
